...
var validateQueryParams = function (imageName, width, height, imagesDirectories) { return __awaiter(void 0, void 0, void 0, function () {
    var responseStatus, isImageExist, responseStatus, responseStatus;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!imageName) {
                    responseStatus = (0, handle_response_1.default)('BAD_REQUEST');
                    return [2 /*return*/, {
            ...
            case 1:
                isImageExist = _a.sent();
                if (!isImageExist) {
                    responseStatus = (0, handle_response_1.default)('NOT_FOUND');
                    return [2 /*return*/, {
                            isQueriesValid: false,
                            responseStatus: responseStatus,
                            extraValues: { 'received-imageName': imageName }
