...
exports.createFolderIfNotExist = exports.isThisFileExist = void 0;
var file_exists_1 = __importDefault(require("file-exists"));
var path_1 = __importDefault(require("path"));
var fs_1 = __importDefault(require("fs"));
var isThisFileExist = function (file, dirPath) { return __awaiter(void 0, void 0, void 0, function () {
    var isExist;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, file_exists_1.default)(file, { root: dirPath })];
            case 1:
                isExist = _a.sent();
...
exports.isThisFileExist = isThisFileExist;
var isThisFolderExist = function (absoluteDirPath) { return __awaiter(void 0, void 0, void 0, function () {
    var isExist;
    return __generator(this, function (_a) {
        isExist = fs_1.default.existsSync(absoluteDirPath);
        return [2 /*return*/, isExist];
    });
}); };
